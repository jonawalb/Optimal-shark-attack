...
EventKind = Literal["INDIVIDUAL", "MEDLEY_RELAY", "MIXED_AGE_FREE_RELAY"]
...
def _build_catalog() -> list[Event]:
    ...
    # Same-age, same-gender medley relays: 4 legs (back, breast, fly, free).
    # 8U / 9-10 / 11-12 / 13-14 swim 4 lengths total. 15-18 swims 8 lengths.
    for ag in AGE_GROUPS:
        for gen in ("B", "G"):
